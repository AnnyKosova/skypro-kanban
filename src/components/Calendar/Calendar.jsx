  ...
  const renderCalendarDays = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      days.push(
        <div 
          key={day} 
          className={`calendar__cell _cell-day ${isSelected ? '_active-day' : ''} ${isCurrent ? '_current' : ''}`}
    ...
    <div className="calendar">
      ...
      <div className="calendar__block">
        <div className="calendar__nav">
          <div className="calendar__month">{getMonthName(currentDate)} {currentDate.getFullYear()}</div>
          <div className="nav__actions">
            ...
            <div className="nav__action" data-action="next" onClick={handleNextMonth}>
              <svg xmlns="http://www.w3.org/2000/svg" width="6" height="11" viewBox="0 0 6 11">
                <path d="M0.27055 9.04727C-0.0901833 9.37959 -0.090184 9.9167 0.27055 10.249C0.633779 10.5837 1.2246 10.5837 1.58783 10.249L5.47151 6.67117C6.17616 6.02201 6.17616 4.97799 5.47151 4.32883L1.58782 0.75097C1.2246 0.416344 0.633778 0.416344 0.270549 0.75097C-0.0901831 1.0833 -0.090184 1.62041 0.270549 1.95273L4.12103 5.5L0.27055 9.04727Z" />
              </svg>
            </div>
          </div>
        </div>
        ...
        <input type="hidden" id="datepick_value" value={selectedDate ? selectedDate.toLocaleDateString('ru-RU') : ''} />
        <div className="calendar__period">
          <p className="calendar__p date-end">
            Срок исполнения: <span className="date-control">
              {selectedDate ? selectedDate.toLocaleDateString('ru-RU') : 'не выбрано'}
            </span>
          </p>
        </div>
      </div>
